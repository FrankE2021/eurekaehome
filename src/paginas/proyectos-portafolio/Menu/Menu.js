...
import { PRODUCTOS } from './MenuDatos';
      ...
      <div className="productos">
        {
          ...
          <div key={valor.id} className="producto">
            <img id={valor.id} onMouseEnter={conocer} onMouseLeave={limpiar} onClick={comprar} src={require('./imagenes/'+valor.imagen)} alt={valor.nombre}/>
            </div>)
        }
      </div>
    </section>
    ...
    <section className="carrito">
      {
        COMPRA.map(valor=>
          <div className="producto" key={valor}>
            <img alt='Producto' id={PRO[PRO.findIndex(cosa=>cosa.id===valor)].id} onMouseEnter={conocer} onMouseLeave={limpiar} onClick={devolver}
            src={require('./imagenes/'+PRO[PRO.findIndex(cosa=>cosa.id===valor)].imagen)}/> 
          </div>)
      }
    </section>
    <section className="nota">
      <img alt='logo' src={require('./imagenes/logo.webp')}/>
      <div className="lista">
        {
          COMPRA.map(valor=>
            <div className="linea">
